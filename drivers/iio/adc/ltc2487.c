 ...
 *
 * Datasheet: http://cds.linear.com/docs/en/datasheet/2487fd.pdf
 */
...
static int ltc2487_wait_conv(struct ltc2487_st *st)
{
	...
	if (time_elapsed < LTC2487_CONVERSION_TIME_MS) {
		...
		if (msleep_interruptible(
		    LTC2487_CONVERSION_TIME_MS - time_elapsed))
			return -ERESTARTSYS;
...
static const struct iio_chan_spec ltc2487_channel[] = {
	LTC2487_CHAN_DIFF(0, LTC2487_DIFF),
	LTC2487_CHAN_DIFF(1, LTC2487_DIFF),
};
			 ...
			 const struct i2c_device_id *id)
{
	...
	indio_dev->channels = ltc2487_channel;
	indio_dev->num_channels = ARRAY_SIZE(ltc2487_channel);
...
static void ltc2487_remove(struct i2c_client *client)
{
...
static struct i2c_driver ltc2487_driver = {
	.driver = {
		.name = "ltc2487",
		.of_match_table = of_match_ptr(ltc2487_of_match),
	},
	.probe = ltc2487_probe,
	.remove = ltc2487_remove,
	.id_table = ltc2487_id,
};
