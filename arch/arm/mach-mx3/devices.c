...
#elif defined(CONFIG_MACH_MA8XX)
static struct mxc_audio_platform_data mxc_audio_data;
...
#elif defined(CONFIG_PCMCIA_MA8XX) || defined(CONFIG_PCMCIA_MA8XX_MODULE)
#include <asm/arch/pcmcia.h>
static struct resource ma8xx_pcmcia_resources[] = {
	[0] = {
		.name	= "pcmcia",
...
static struct pcmcia_platform_data ma8xx_pcmcia_platform_data = {
	.card_power_on	= gpio_pcmcia_power_on,
	.card_power_off	= gpio_pcmcia_power_off,
};

static struct platform_device ma8xx_pcmcia_device = {
	.name = "ma8xx_pcmcia",
	.id = 0,
	.dev		= {
		.platform_data	= &ma8xx_pcmcia_platform_data,
	},
	.num_resources	= ARRAY_SIZE(ma8xx_pcmcia_resources),
	.resource	= ma8xx_pcmcia_resources,
};
static inline void mxc_init_pcmcia(void)
{
	platform_device_register(&ma8xx_pcmcia_device);
}
#else
static inline void mxc_init_pcmcia(void)
{
