...
#else
#define MX35_CS4_IO_ADDRESS(x)  \
	(((x) - MX35_CS4_BASE_ADDR) + MX35_CS4_BASE_ADDR_VIRT)

#define MX35_CS5_IO_ADDRESS(x)  \
	(((x) - MX35_CS5_BASE_ADDR) + MX35_CS5_BASE_ADDR_VIRT)

#define MX35_IO_P2V(x) \
	(((x >= MX35_CS4_BASE_ADDR) && (x < (MX35_CS4_BASE_ADDR + MX35_CS4_SIZE))) ? MX35_CS4_IO_ADDRESS(x) : \
	 ((x >= MX35_CS5_BASE_ADDR) && (x < (MX35_CS5_BASE_ADDR + MX35_CS5_SIZE))) ? MX35_CS5_IO_ADDRESS(x) : \
	 IMX_IO_P2V(x))
#endif
