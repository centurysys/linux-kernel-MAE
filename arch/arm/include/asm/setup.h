...
/* Century Systems MA-8xx uboot parameters */
#define ATAG_CENTURY   0x41000404
struct tag_century_uboot {
        __u8  macAddr[6];
};
#endif
...
#ifdef CONFIG_MACH_MA8XX
                /*
                 * Century Systems MA-8xx specific
                 */
                struct tag_century_uboot century;
#endif
